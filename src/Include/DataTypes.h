...
struct parameters {
	...
	/* flow over sphere properties */
	double sphere_radius;
	double sphere_cent_x, sphere_cent_y, sphere_cent_z; 
	short int current_rank_has_sphere; 
	short int flow_over_sphere;
};
...
*/
    ...
    /* Pointer to store any quantity temporarily */
    Vec *G_anything;
